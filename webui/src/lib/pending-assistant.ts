...
// useWebSocket 和 useChat 都需要访问 pending 状态，提取为模块级变量避免 useRef 跨 hook 不可达。

import type { ChatMessage } from '../types/api';

// 当前流式 assistant 消息（按 sessionId 索引）
const pendingMap: Record<string, ChatMessage> = {};
...
export const pendingAssistant = {
  ...
  set(sessionId: string, msg: ChatMessage): void {
