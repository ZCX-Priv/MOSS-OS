...
// 三 tab：configured（已配置）/ history（运行历史）/ templates（模板）。
...
import type { PageType, AutomationTab } from '../../types';
...
export function AutomationPage({ onNavigate: _onNavigate }: AutomationPageProps) {
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      >
        <div className="border-b border-border px-6 py-3">
          <TabsList>
            ...
            <TabsTrigger value="history" className="gap-1.5">
              ...
              <Badge variant="secondary">{allHistory.length}</Badge>
            </TabsTrigger>
        ...
        {/* 已配置 */}
        <TabsContent value="configured" className="flex-1 overflow-auto p-6">
